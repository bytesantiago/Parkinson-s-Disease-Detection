...
def loadmeta():
    ...
    S = 466 #540 #324 #1526 #466
    Sc = 449 #540 #324 #1509 #449
    Smed = 471 #540 #324 #1516 #471
    flo = (13,30)
    fhi = (50, 150)
...
def loadPD(EO, all_chan, repository):
    '''
    ...
    if repository == 'UNM':
        if all_chan == True:
            if EO == True:
                dirB='../UNM_Dataset/all_channels_processedData/off_med/eyes_open/'
                tempB = []
                ...
                dirC='../UNM_Dataset/all_channels_processedData/on_med/eyes_open/'
                tempC = []
                ...
                dirE='../UNM_Dataset/all_channels_processedData/control/eyes_open/'
                tempE = []
                ...
                dirB='../UNM_Dataset/all_channels_processedData/off_med/eyes_closed/'
                tempB = []
                for file in os.listdir(dirB):
                    fl = dirB + file
                    tempB.append(fl)
                ...
                dirC='../UNM_Dataset/all_channels_processedData/on_med/eyes_closed/'
                tempC = []
                for file in os.listdir(dirC):
                    fl = dirC + file
                    tempC.append(fl)
                ...
                dirE='../UNM_Dataset/all_channels_processedData/control/eyes_closed/'
                tempE = []
                for file in os.listdir(dirE):
                    fl = dirE + file
                    tempE.append(fl)
            ...
            elif EO == 'all' or EO == 'ALL':
                dirA='../UNM_Dataset/all_channels_processedData/off_med/eyes_open/'
                dirB='../UNM_Dataset/all_channels_processedData/off_med/eyes_closed/'
                tempB = []
                for file0,file1 in zip(os.listdir(dirA), os.listdir(dirB)):
                    fl = dirA + file0
                    f2 = dirB + file1
                    tempB.append(fl)
                    tempB.append(f2)
                ...
                dirC='../UNM_Dataset/all_channels_processedData/on_med/eyes_open/'
                dirD='../UNM_Dataset/all_channels_processedData/on_med/eyes_closed/'
                tempC = []
                for file0,file1 in zip(os.listdir(dirC), os.listdir(dirD)):
                    fl = dirC + file0
                    f2 = dirD + file1
                    tempC.append(fl)
                    tempC.append(f2)
                tempC = sorted(tempC)    # class: 1     val:  -1

                dirE='../UNM_Dataset/all_channels_processedData/control/eyes_open/'
                dirF='../UNM_Dataset/all_channels_processedData/control/eyes_closed/'
                tempE = []
                for file0,file1 in zip(os.listdir(dirE), os.listdir(dirF)):
                    fl = dirE + file0
                    f2 = dirF + file1
                    tempE.append(fl)
                    tempE.append(f2)
            ...
            if EO == True:
                dirB='../UNM_Dataset/C3&C4_channels_data/off_med/eyes_open/'
                tempB = []
                for file in os.listdir(dirB):
                    fl = dirB + file
                    tempB.append(fl)
                ...
                dirC='../UNM_Dataset/C3&C4_channels_data/on_med/eyes_open/'
                tempC = []
                for file in os.listdir(dirC):
                    fl = dirC + file
                    tempC.append(fl)
                ...
                dirE='../UNM_Dataset/C3&C4_channels_data/control/eyes_open/'
                tempE = []
                for file in os.listdir(dirE):
                    fl = dirE + file
                    tempE.append(fl)
                ...
                dirB='../UNM_Dataset/C3&C4_channels_data/off_med/eyes_closed/'
                tempB = []
                for file in os.listdir(dirB):
                    fl = dirB + file
                    tempB.append(fl)
                ...
                dirC='../UNM_Dataset/C3&C4_channels_data/on_med/eyes_closed/'
                tempC = []
                for file in os.listdir(dirC):
                    fl = dirC + file
                    tempC.append(fl)
                ...
                dirE='../UNM_Dataset/C3&C4_channels_data/control/eyes_closed/'
                tempE = []
                for file in os.listdir(dirE):
                    fl = dirE + file
                    tempE.append(fl)
                ...
                dirA='../UNM_Dataset/C3&C4_channels_data/off_med/eyes_open/'
                dirB='../UNM_Dataset/C3&C4_channels_data/off_med/eyes_closed/'
                tempB = []
                for file0,file1 in zip(os.listdir(dirA), os.listdir(dirB)):
                    fl = dirA + file0
                ...
                dirC='../UNM_Dataset/C3&C4_channels_data/on_med/eyes_open/'
                dirD='../UNM_Dataset/C3&C4_channels_data/on_med/eyes_closed/'
                tempC = []
                for file0,file1 in zip(os.listdir(dirC), os.listdir(dirD)):
                    fl = dirC + file0
                    f2 = dirD + file1
                ...
                dirE='../UNM_Dataset/C3&C4_channels_data/control/eyes_open/'
                dirF='../UNM_Dataset/C3&C4_channels_data/control/eyes_closed/'
                tempE = []
                for file0,file1 in zip(os.listdir(dirE), os.listdir(dirF)):
                    fl = dirE + file0
                    f2 = dirF + file1
    ...
    elif repository == 'UCSD':
        if all_chan == True:    
            dirB='../UCSD_Dataset/all_channels_processedData/off_med/'
            tempB = []
            for file in os.listdir(dirB):
                fl = dirB + file
                tempB.append(fl)
            ...
            dirC='../UCSD_Dataset/all_channels_processedData/on_med/'
            tempC = []
            for file in os.listdir(dirC):
                fl = dirC + file
                tempC.append(fl)
            ...
            dirE='../UCSD_Dataset/all_channels_processedData/control/'
            tempE = []
            for file in os.listdir(dirE):
                fl = dirE + file
                tempE.append(fl)
            ...
            dirB='../UCSD_Dataset/C3&C4_channels_data/off_med/'
            tempB = []
            for file in os.listdir(dirB):
                fl = dirB + file
                tempB.append(fl)
            ...
            dirC='../UCSD_Dataset/C3&C4_channels_data/on_med/'
            tempC = []
            for file in os.listdir(dirC):
                fl = dirC + file
                tempC.append(fl)
            ...
            dirE='../UCSD_Dataset/C3&C4_channels_data/control/'
            tempE = []
            for file in os.listdir(dirE):
                fl = dirE + file
                tempE.append(fl)
...
def measure_shape(eeg, rejects, boundaryS=100, ampPC=0, widthS=3, esrmethod='aggregate'):
    ...
    for s in range(S):
        pks['off'][s], trs['off'][s] = findpt(eeg['off'][s], flo, Fs=Fs, boundary=boundaryS)
    ...
    for s in range(Smed):
        pks['on'][s], trs['on'][s] = findpt(eeg['on'][s], flo, Fs=Fs, boundary=boundaryS)
    ...
    for s in range(Sc):
        pks['C'][s], trs['C'][s] = findpt(eeg['C'][s], flo, Fs=Fs, boundary=boundaryS)
...
def metricsegment(eeg,rejects,group,subject,sWindow,sSlide):
    ...
    Fs, t, S, Sdy, Smed, flo, fhi = loadmeta()
    pacseg={}
...
def firf(x,f_range, fs=512, w=3, rmvedge=True):
    """
